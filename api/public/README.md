...
This directory defines the **public contract** consumed by Turbo Notify customers (developers integrating the platform).
...
| Who | What they do |
|-----|--------------|
| **External developers** | Integrate Turbo Notify into their systems |
| **Technical partners** | Build solutions on top of the platform |
| **Internal teams** | Implement and maintain the API |
...
5. `/docs/api/public/changelog.md`
